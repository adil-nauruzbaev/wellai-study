...
class FirstNameTextfieldData extends AppTextfieldData {
  FirstNameTextfieldData({
    super.enabled,
    super.initial,
    super.maxLength,
    super.nextFocus,
...
class FirstNameTextField extends AppTextfield {
  FirstNameTextField({
    super.key,
    FirstNameTextfieldData? data,
  }) : super(
          data: data ?? FirstNameTextfieldData(),
        );
}
