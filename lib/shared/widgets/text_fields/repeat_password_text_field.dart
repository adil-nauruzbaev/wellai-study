...
class RepeatPasswordTextField extends AppTextfield {
  RepeatPasswordTextField({
    super.key,
    RepeatPasswordTextFieldData? data,
  }) : super(
          data: data ?? RepeatPasswordTextFieldData(),
        );
}

class RepeatPasswordTextFieldData extends AppTextfieldData {
  RepeatPasswordTextFieldData({
    super.onChanged,
    super.onSubmit,
    super.onFocusLost,
    super.enabled = true,
